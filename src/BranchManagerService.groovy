...
//  init(team, project, api, "develop")
  ...
  sh '''
  mvn "-DallowSnapshots=true -DautoVersionSubmodules=true " + "-DreleaseBranchVersionSuffix=RC1 -DupdateDependencies=true" -s /usr/share/maven/conf/settings.xml, "jgitflow:release-start -X" 
  '''
