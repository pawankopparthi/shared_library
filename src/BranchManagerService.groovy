...
//  init(team, project, api, "develop")
  ...
  '''*/
  mvn -s /usr/share/maven/conf/settings.xml runGitflowCommands -DallowSnapshots=true -DautoVersionSubmodules=true -DreleaseBranchVersionSuffix=RC1 -DupdateDependencies=true jgitflow:release-start -X
